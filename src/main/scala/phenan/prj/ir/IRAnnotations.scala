...
case class IRMethodAnnotations (signature: Option[JMethodSignature], operator: Option[JOperatorSyntaxDef], isPure: Boolean, isFinalizer: Boolean, others: List[IROtherAnnotation])
